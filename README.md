...
## Prerequisites
	...
	is accessible from "RUT9M_R_GPL_00.07.07.3/scripts/dockerbuild".
...
## Building with Docker environment
	...
	2. Extract the  archive to an empty folder
		...
		$ mkdir RUT9M_R_GPL_00.07.07.3
		$ tar -xzf ~/Downloads/RUT9M_R_GPL_00.07.07.3.tar.gz -C RUT9M_R_GPL_00.07.07.3

	3. Update feeds

		$ cd RUT9M_R_GPL_00.07.07.3
	...
	5. Prepare packages for offline installation (optional)
		...
		After this you can find packages in "RUT9M_R_GPL_00.07.07.3/bin/packages/<arch_name>/zipped_packages".
...
## Installation
	...
	After successful build you will get the firmware file in
		"RUT9M_R_GPL_00.07.07.3/bin/targets/ramips/generic/tltFws".
...
## WebUI rebranding
	...
	All changes should be done in "RUT9M_R_GPL_00.07.07.3/package/feeds/vuci/vuci-ui-core/bin/dist" folder.
...
## SSH Banner
	...
	2. Use figlet tool to generate needed text:
		...
		$ figlet YOUR_TEXT > "RUT9M_R_GPL_00.07.07.3/package/base-files/files/etc/banner.logo"
...
## Default Password Change
	...
	To change the default device password changes need to be made inside "RUT9M_R_GPL_00.07.07.3/package/base-files/files/lib/preinit/84_set_password" file.
