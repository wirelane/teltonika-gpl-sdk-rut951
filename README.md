...
## Prerequisites
	...
	is accessible from "RUT9M_R_GPL_00.07.15.1/scripts/dockerbuild".
...
## Building with Docker environment
	...
	2. Extract the  archive to an empty folder
		...
		$ mkdir RUT9M_R_GPL_00.07.15.1
		$ tar -xzf ~/Downloads/RUT9M_R_GPL_00.07.15.1.tar.gz -C RUT9M_R_GPL_00.07.15.1

	3. Update feeds

		$ cd RUT9M_R_GPL_00.07.15.1
	...
	5. Prepare packages for offline installation (optional)
		...
		After this you can find packages in "RUT9M_R_GPL_00.07.15.1/bin/packages/<arch_name>/zipped_packages".
...
## Installation
	...
	After successful build you will get the firmware file in
		"RUT9M_R_GPL_00.07.15.1/bin/targets/ramips/generic/tltFws".
...
## WebUI rebranding
	...
	All changes should be done in "RUT9M_R_GPL_00.07.15.1/package/feeds/vuci/vuci-ui-core/bin/dist" folder.
...
## SSH Banner
	...
	2. Use figlet tool to generate needed text:
		...
		$ figlet YOUR_TEXT > "RUT9M_R_GPL_00.07.15.1/package/base-files/files/etc/banner.logo"
...
## Default IP Change
	...
	1. Open the device family file in "RUT9M_R_GPL_00.07.15.1/target/linux/ramips/image/devices/rut9xx_family.mk"
	...
	4. Regenerate the tmpinfo files by running:
		...
		$ rm -rf "RUT9M_R_GPL_00.07.15.1/tmp"

## Default Password Change

	To change the default device password changes need to be made inside "RUT9M_R_GPL_00.07.15.1/package/base-files/files/lib/preinit/84_set_password" file.
