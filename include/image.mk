...
define Image/BuildDTB
	...
	$(TARGET_CROSS)cpp -nostdinc -x assembler-with-cpp \
		...
		-undef -D__DTS__ $(3) \
		-o $(2).tmp $(1)
	$(LINUX_DIR)/scripts/dtc/dtc $(DEVICE_DTC_FLAGS) -O dtb \
		-i$(dir $(1)) $(DTC_FLAGS) $(4) \
		-o $(2) $(2).tmp
	$(RM) $(2).tmp
endef
...
DEFAULT_DEVICE_VARS := \
  ...
  VID_HDR_OFFSET UBINIZE_OPTS UBINIZE_PARTS MKUBIFS_OPTS DEVICE_DTS DEVICE_DTC_FLAGS\
  DEVICE_DTS_CONFIG DEVICE_DTS_DIR DEVICE_FDT_NUM SOC BOARD_NAME \
  UIMAGE_MAGIC UIMAGE_NAME \
  SUPPORTED_DEVICES IMAGE_METADATA KERNEL_ENTRY KERNEL_LOADADDR \
  IMAGE_PREFIX DEVICE_PACKAGES DEVICE_PACKAGES.basic UBOOT_PATH IMAGE_SIZE \
  ...
  DEVICE_CHECK_PATH DEVICE_USB_JACK_PATH DEVICE_WLAN_BSSID_LIMIT \
  ...
  DEVICE_DOT1X_SERVER_CAPABILITIES DEVICE_EOL \
  $(DEVICE_HARDWARE_VARS)
...
define Device/Build/initramfs
  ...
  $(BUILD_DIR)/json_info_files/$$(KERNEL_INITRAMFS_IMAGE).json: $(BIN_DIR)/$$(KERNEL_INITRAMFS_IMAGE)
	...
	DEVICE_MTD_LOG_PARTNAME="$$(DEVICE_MTD_LOG_PARTNAME)" \
	...
	DEVICE_CHECK_PATH="$$(DEVICE_CHECK_PATH)" \
...
TARGET_PROFILE_VARS = $(foreach var,$(DEVICE_HARDWARE_VARS),Target-Profile-$(subst /,-,$(var)): $($(var))$(newline))

define Device/DumpInfo
Target-Profile: DEVICE_$(1)
Target-Profile-Name: $(DEVICE_DISPLAY)
Target-Profile-Libc: $(DEVICE_LIBC)
Target-Profile-Packages: $(DEVICE_PACKAGES) $(if $(CONFIG_BUILD_FACTORY_TEST_IMAGE),,$(DEVICE_PACKAGES.basic))
