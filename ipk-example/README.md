...
1. **Copy Package Files**
   ...
   ```sh
   cp -r "ipk-example" "RUT9M_R_GPL_00.07.24.3/package/base/example_package"
   ```
...
3. **Build the Package**
   ...
   > `RUT9M_R_GPL_00.07.24.3/bin/packages/ramips/base`
...
1. **Copy Package to Device**
   ...
   ```sh
   scp "RUT9M_R_GPL_00.07.24.3/bin/packages/ramips/base/example_package_1.0-1_ramips.ipk" \
...
1. **Modify Package Configuration**
   ...
   Edit `RUT9M_R_GPL_00.07.24.3/ipk_packages.json`:
...
4. **Compile Package Manager Packages**
   ...
   > `RUT9M_R_GPL_00.07.24.3/bin/packages/<arch_name>/zipped_packages`
