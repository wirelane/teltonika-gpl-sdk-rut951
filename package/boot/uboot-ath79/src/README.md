# TODOs
* generalize `sr_led_animation()` function, so that we have a single copy of LED animation code

# !!! Correct LED behaviour, to be implemented on ALL RUTOS devices !!!

Please read the always up-to-date wiki page: https://git.teltonika.lt/teltonika/rutx_open/-/wikis/Documentation/2.20-LED-behaviour
