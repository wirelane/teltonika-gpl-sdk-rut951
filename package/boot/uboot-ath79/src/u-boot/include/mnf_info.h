...
struct mnf_field_s {
	...
	mnf_field_flags flags;
        ...
        #define MNF_FIELD(short, long, desc, offset, len, restore, flags) { short, long, desc, offset, len, restore, flags }
#else
        #define MNF_FIELD(short, long, desc, offset, len, restore, flags) { short, long, "", offset, len, restore, flags }
#endif
