 ...
 */
	...
	#define GPIO_POWER_LED_L (u64)(GPIO44)

	// LED order is important!
	#define CONFIG_MTK_LED_ANIMATION_MASK 	GPIO39, GPIO40, GPIO41, \
						GPIO42, GPIO43

	#define CONFIG_MTK_GPIO_MASK_IN 	(u64)(GPIO11 | GPIO37)
	...
	#define GPIO_POWER_LED_L (u64)(GPIO36)

	#define CONFIG_MTK_LED_ANIMATION_MASK	GPIO44, GPIO46, GPIO41, GPIO40, GPIO39

	#define CONFIG_MTK_GPIO_MASK_IN			(u64)(GPIO0 | GPIO4)
